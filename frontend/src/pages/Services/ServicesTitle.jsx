function ServicesTitle() {
  return (
    <div className="services-title">
      <svg
        className="services-title__bg"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 2384.399 298"
      >
        <defs>
          <linearGradient
            id="linear-gradient"
        ...
        <g id="arrows" transform="translate(252.997 -353)">
          ...
          <g
            id="gradient-2"
            data-name="gradient"
            transform="translate(1061 902.098) rotate(180)"
          >
            <rect
              id="Rectangle_199-2"
              data-name="Rectangle 199"
              width="298"
              height="440"
              transform="translate(1248 251.098) rotate(90)"
              fill="url(#linear-gradient)"
            />
            <rect
              id="Rectangle_200-2"
        ...
        <foreignObject x="450" y="25" width="1000" height="350">
          <div
            className="services-title__container"
            xmlns="http://www.w3.org/1999/xhtml"
          >
            <h1 className="services-title__heading">OUR SERVICES</h1>
            <br />
            <p className="services-title__description">
              CRAFT&apos;s services range from development and management to
              other services needed for any given project. CRAFT&apos;s rigid
              due diligence process helps make our services a step above our
              competitors.
            </p>
          </div>
        </foreignObject>
