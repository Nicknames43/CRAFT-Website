            ...
            <div className="search-bar__bg">
                <svg viewBox="0 0 2464.298 122.465">
                    ...
                    <foreignObject x="561" y="12" width="1450" height="99">
                        <form xmlns="http://www.w3.org/1999/xhtml" id="property-search-input" className="search-bar__form">
                            <input type="text" placeholder="CITY, POSTAL CODE, ADDRESS, PROPERTY NAME" className="search-bar__type"/>
                            <input type="image" src={searchIcon} alt="Search" className="search-bar__submit"/>
                            <input type="image" src={mapIcon} alt="Map" className="search-bar__map"/>
                        </form>
                    </foreignObject>
                </svg>
            </div>
