...
function Welcome() {
  return (
    <div className="welcome">
      <div className="welcome__arrows">
        <svg viewBox="0 0 2384.399 313">
          <defs>
            <linearGradient
              id="linear-gradient"
              x1="0.5"
          ...
          <foreignObject x="475" y="0" width="1300" height="292">
            <div
              className="welcome__statement-container"
              xmlns="http://www.w3.org/1999/xhtml"
            >
              <p className="welcome__statement">WELCOME TO THE</p>
              <p className="welcome__statement">CRAFT DEVELOPMENT</p>
              <p className="welcome__statement">CORPORATION</p>
            </div>
          </foreignObject>
        </svg>
      </div>
      ...
      <div className="welcome__learn-more-container">
