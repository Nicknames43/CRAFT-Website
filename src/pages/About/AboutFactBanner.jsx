    ...
    <div className="fact-banner">
      <div className="fact-banner__bg">
        <svg viewBox="0 0 2464.298 122.465">
          ...
          <foreignObject x="561" y="12" width="1400" height="99">
            <div
              className="fact-banner__container"
              xmlns="http://www.w3.org/1999/xhtml"
            >
              <p className="fact-banner__fact">
                SINCE ITS INCEPTION, CRAFT HAS BEEN INVOLVED IN THE DEVELOPMENT
                OF 1.8 MILLION + SQUARE FEET OF RETAIL, OFFICE, & RESIDENTIAL
                PROJECTS.
              </p>
            </div>
          </foreignObject>
...
export default AboutFactBanner
